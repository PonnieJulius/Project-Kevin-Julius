                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"data-bs-placement="top"class="avatar avatar-lg align-items-center pull-up"title="opljshkskjk"
                                >
                                <img src="" alt="Avatar" class="rounded-5"/>
                                </li>
                            </ul>
                        </td>
                            <td></td>
                            <td><a class="dropdown-item btn btn-primary text-center align-items-center rounded-5" href="category_edit.php"><i class="bx bx-edit-alt me-1"></i></a></td>
                        <td>
